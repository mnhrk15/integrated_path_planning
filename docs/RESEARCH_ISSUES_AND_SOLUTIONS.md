...
- **Q2（multi-circle 計画で侵入は消えるか）: 0/123 ラン、全シナリオで矩形クリアランスが有意に増加**（ΔS1 +0.70〜+1.25 m、S2 +0.27〜+0.36 m、S3 +0.45〜+1.62 m、確率手法は全セル p<0.05）。Time コスト: S2 +1.5〜+1.6 s、S3 +4.0〜+5.4 s（CV は +10.6 s）。S1 は +1.0 s だが multi_circle 条件で 30/41 ランが total_time 上限 19.9 s に到達（ゴール未到達の右側打切り、コストは過小評価）。
